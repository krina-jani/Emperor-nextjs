  ...
  return (
    ...
    >
      ...
      {mounted && createPortal(
        <>
          <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true" style={accentColor ? ({ '--sm-accent': accentColor } as React.CSSProperties) : undefined}>
            {(() => {
          ...
          <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open} style={accentColor ? ({ '--sm-accent': accentColor } as React.CSSProperties) : undefined}>
